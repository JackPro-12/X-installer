...
check_token() {
  ...
  if [ "$USER_TOKEN" = "faxzsygnindya" ]; then
    ...
    echo -e "${YELLOW}WHATSAPP : 6282311435959${NC}"
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/X-Faxz/X-installer/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/X-Faxz/X-installer/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/X-Faxz/X-installer/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/X-Faxz/X-installer/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${RED} ggg.    ' .gggggggp.        • Support by AlwaysFaxz     ${NC}"
  echo -e "${RED}  'ggg    '-.__'              • Whatsapp : 0823-1143-5959 ${NC}"
  echo -e "${RED}    ggg                                                   ${NC}"
  echo -e "${RED}      ggg                                                 ${NC}"
  echo -e "${RED}        ggg.                                              ${NC}"
  echo -e "${RED}          ggg.                                            ${NC}"
